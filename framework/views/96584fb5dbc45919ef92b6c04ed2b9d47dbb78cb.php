...
<main>
        ...
        <div class="archive-header pt-50 text-center">
            <div class="container">
                <h2 class="font-weight-900"><?php echo e(__('customlang.art')); ?></h2>
                <div class="breadcrumb">
                    <a href="/" rel="nofollow">Home</a>
                    <a href="/blogs" rel="nofollow"><?php echo e(__('customlang.blogs')); ?></a>
                    <span></span> <?php echo e(__('customlang.art')); ?>
...
<?php echo $__env->make('components.ui', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/writers/resources/views/categories/art.blade.php ENDPATH**/ ?>